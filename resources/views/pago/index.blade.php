                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="{{ route('pagos.store') }}" method="POST" class="form-horizontal">
                                        ...
                                        const tipoPagoElectronico = document.getElementById("tipoPagoElectronico");
                                        const campoNumeroOperacion = document.getElementById("campoNumeroOperacion");
                                        const campoMonto = document.getElementById("campoMonto");

                                        // Reset display for all fields initially
                                        tipoPagoElectronico.style.display = "none";
                                        ...
                                        switch (metodoPago) {
                                            ...
                                            break;
                                            case "Tarjetas de débito":
                                            campoMonto.style.display = "block";
                                            break;
                                            case "Pagos electrónicos":
                                            tipoPagoElectronico.style.display = "block";
                                            campoMonto.style.display = "block";
                                            campoNumeroOperacion.style.display = "block";
                                            break;
                                        }
                                        ...
                                        // Call the function initially to set the display based on the default selected value (if any)
                                        mostrarCamposAdicionales();

                                        // Attach the function to the onchange event of the select element
                                        document.getElementById("metodo_pago").addEventListener("change", mostrarCamposAdicionales);
